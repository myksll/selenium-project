...
public class T2_T3_Explicit_Wait_Practices {
    ...
    public void t2_remove_checkbox_test(){
       ...
       // BrowserUtils.waitForInvisibilityOf(dynamicControlsPage.loadingBar);
        ...
        try{
            ...
            Assert.assertTrue(dynamicControlsPage.add.isDisplayed());
    ...
    public void t3_input_box_test(){
        ...
        //4- Wait until “loading bar disappears”  Using the custom utility method 'waitForInvisibilityOf' to wait loadingBar disappears
        BrowserUtils.waitForInvisibilityOf(dynamicControlsPage.loadingBar);
