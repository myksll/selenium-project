...
public class T7_T8_T9_POM_Practices {
    ...
    @Test
    public void t7_field_required_error_message_test(){  // pages/libraryLoginPage

        //TC #7: Required field error message test

        //3- Do not enter any information
        //4- Click to “Sign in” button
        //LibraryLoginPage loginPage = new LibraryLoginPage();-->I want to create a class for LibraryLoginPage top on the page
